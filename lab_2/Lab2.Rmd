...
• Write a function which takes one predictor fits a linear model and appends a row of results to results.table in the same format as before with the name of the predictor in the rowname. Identify the
predictor that produces the best performing model.
