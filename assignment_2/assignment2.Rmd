...
results
# Genetic risk score
# snps.grs <- association[p.value < t]
# gdm.grs <- gdm.dt[, .SD, .SDcols = association[p.value < t]$snp]
# unweighted.score <- as.matrix(gdm.grs) %*% sign(snps.grs$beta)
# weighted.score <- as.matrix(gdm.grs) %*% snps.grs$beta
