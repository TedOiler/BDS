...
risk.3.logistic   <- glm(gdm.dt$pheno ~ gdm.dt$weighted.risk.3, family='binomial')
risk.4.logistic   <- glm(gdm.dt$pheno ~ gdm.dt$weighted.risk.4, family='binomial')
risk.FTO.logistic <- glm(gdm.dt$pheno ~ gdm.dt$weighted.risk.FTO, family='binomial')
